...
/** Tests the compressor's static curve, soft-knee transition, and temporal memory. */
class CompressorTest {
    /** Creates fast settings without makeup to isolate the reduction under test. */
    ...
    /** Verifies the uncompressed region at and below threshold. */
    ...
    /** Verifies known reductions for 6:1, 20:1, and 1:1 ratios. */
    ...
    /** Confirms that the knee introduces gradual reduction around threshold. */
    ...
    /** Checks stateful attack/release and shared gain across both channels. */
    ...
    /** Ensures a runtime update enables compression without rebuilding the processor. */
